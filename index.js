...
async function connectToWA() {
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("𝘾𝙃𝘼𝙉𝙐𝙆𝘼-𝙈𝘿 installed successful ✅");
      console.log("𝘾𝙃𝘼𝙉𝙐𝙆𝘼-𝙈𝘿 connected to whatsapp ✅");

      let up = `𝘾𝙃𝘼𝙉𝙐𝙆𝘼-𝙈𝘿 connected successful ✅`;
      let up1 = `Hello CHANUKA-MD, I made bot successful`;
      ...
      robin.sendMessage("94741469245@s.whatsapp.net", {
        image: {
...
app.get("/", (req, res) => {
  res.send("𝙃𝙚𝙮, 𝘾𝙃𝘼𝙉𝙐𝙆𝘼-𝙈𝘿 𝙎𝙩𝙖𝙧𝙩𝙚𝙙✅");
});
app.listen(port, () =>
